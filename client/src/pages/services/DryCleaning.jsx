        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <p className="text-gray-400 text-lg leading-9 max-w-2xl mb-10">
              ...
              Protect your premium garments with expert dry cleaning solutions
              designed for delicate fabrics, luxury wear, and professional clothing care.
      ...
      <section className="px-6 md:px-20 py-24 bg-[#0b0b0b]">
        ...
        <div className="text-center mb-20">
          ...
          <h2 className="text-5xl md:text-6xl font-bold">
            Premium Dry Cleaning Experience
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          ...
          <div className="bg-black border border-gray-800 rounded-3xl p-10 hover:border-white transition duration-300">
            ...
            <p className="text-gray-400 leading-8">
              Elegant finishing for premium and delicate garments.
            </p>
          ...
          <div className="bg-black border border-gray-800 rounded-3xl p-10 hover:border-white transition duration-300">
            ...
            <p className="text-gray-400 leading-8">
              Professional care methods that maintain garment quality.
            </p>
          ...
          <div className="bg-black border border-gray-800 rounded-3xl p-10 hover:border-white transition duration-300">
            ...
            <p className="text-gray-400 leading-8">
              Convenient doorstep pickup and express delivery solutions.
            </p>
